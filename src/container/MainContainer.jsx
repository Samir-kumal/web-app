...
const MainContainer = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="bg-[#118691] w-full h-40 flex items-end justify-center">
        {isClicked && (
          <div className=" w-[80%] h-16 shadow-xl bg-white flex items-center justify-between">
            <div className="flex flex-row">
              {clickedData.map((item) => (
                <div
                  className="flex bg-[#c2f7fc] p-1 h-10 m-2 text-[#398fff]"
                  key={item}
                >
                  {" "}
                  {item}
                  <button
                    ...
                    className="bg-[#118691] text-white hover:bg-slate-900 p-2 flex items-center justify-center text-2xl"
                  >
                    x
                  </button>
                </div>
